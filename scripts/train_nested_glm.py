...
Refactored to use consolidated routines in puck/fit_glm_nested.py.
"""
...
def main():
    print("--- Training Nested GLM (Poly/Tensor) Model ---")
    ...
    fit_glm_nested.train_nested_glm(df_raw, verbose=True)
