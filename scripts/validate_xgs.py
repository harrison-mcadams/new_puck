...
def run_validation(season='20242025', limit_teams=None):
    ...
    fit_xgs.get_or_train_clf(csv_path=f'data/processed/{season}/{season}_df.csv')
    
    # Get team list
    teams_file = 'web/static/teams.json'
    if not os.path.exists(teams_file):
        print(f"Error: {teams_file} not found. Run generate_teams.py first.")
        return
    ...
    # Save
    comp_path = 'analysis/xgs/validation_comparison.csv'
    ...
    plt.tight_layout()
    plt.savefig('analysis/xgs/validation_plot.png')
    print("\nSaved plot to analysis/xgs/validation_plot.png")
