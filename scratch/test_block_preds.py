...
# Generate a synthetic grid of shots in the offensive zone (X: 0 to 89, Y: -42.5 to 42.5)
...
df = pd.DataFrame({
    ...
    'last_event_time_diff': 15,
    'dist_from_last_event': 50,
    'speed_from_last_event': 3,
    'angle_change_last_event': 45,
    'shooter_role': 'F',
    'season': '20252026'
})
